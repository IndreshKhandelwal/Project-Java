...
<%Employee e=(Employee)session.getAttribute("Employee"); 
		...
		Double time=db.calculatetimeinphaseandactivityanddate(request.getParameter("count1"),e.getEId(), request.getParameter("count2"), request.getParameter("count3"), request.getParameter("count4"), scon);
